...
const my3FavoriteTVShows = ['Community', 'Overlord', 'Being Human (US)'];
...
console.log(`A string que a "typeSentence" armazena tem mais de ${numberToCheck} caracteres? ${String(typeSentence.length > 39).replace('t', 'T')}.`);
