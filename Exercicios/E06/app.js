...
console.log('\n02:');
const actualHour = 10;
const isMorning = actualHour >= 6 && actualHour <= 11;
const isAfternoon = actualHour >= 12 && actualHour <= 17;
...
console.log(`O crazyArray tem ${nBoleans} booleans, ${nNumbers} números e ${nStrings} strings.`);
