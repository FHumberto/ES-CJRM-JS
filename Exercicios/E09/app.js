...
console.log(`"Palavra" possui ${getStringLength('Palavra')} caracteres.`);
...
console.log('\n04:');
const getIndex = (char, string) => string.indexOf(char);
console.log(getIndex('o', 'Humberto'));
...
console.log('\n05:');
const hasItem = (item = '', array) => { return (array.includes(item)) ? true : false; }
const arrayNames = ['Humberto', 'Francisco'];
console.log(hasItem('Humberto', arrayNames));
...
console.log('\n06:');
const firstArray = ['Elemento'];
const secondArray = ['X'];

const arrayConcat = (first, second) => first.concat(second);
console.log(arrayConcat(firstArray, secondArray));
...
const logName = () =>
{
  console.log('Humberto Guedes');
}

console.log(invokeCallBack(logName));
...
console.log('\n10:');
const convCallback = (value, callback) =>
{
  return callback(value);
}
const triple = number => number * 3;

console.log(convCallback(33, triple));
...
{
  console.log(`O ${index}º item do array [${array}] é ${element + 1}.`);
})
...
const getLikeMessage = (array = []) =>
{
  switch (array.length)
  {
    ...
    case 3:
      ...
      break;
    default:
      return `${array[0]} e ${array[1]} e mais ${array.length - 2} pessoas curtiram isso`;
      break;
  }
}

console.log(getLikeMessage(['Humberto', 'Bob', 'Edson', 'Francis', 'Dilan']));