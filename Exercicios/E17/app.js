...
console.log(regex.test(paragraph.textContent));
...
const regex04 = /[A-Z0-9]{3}/;

console.log(regex04.test(B99message));
...
{
  event.preventDefault();
  if (formPathern.test(event.target.input.value))
  {
...
// const formPatherns = /[a-zA-Z0-9]{7,11}]/