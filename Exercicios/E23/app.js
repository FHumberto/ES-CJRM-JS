...
const newPeople = people.map(person => person).sort((item1, item2) => item1.score - item2.score);
...
const animalNumbers = animals.map(animal => animal.length);
...
console.log('\n07:');
const countriesPopulation = data
